...
**Next action (automated):** Build opcode scanner ps1 that iterates 0x00-0xFF as 4-byte little-endian messages, logs responses, flags non-zero responses as interesting.
